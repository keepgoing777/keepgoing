...
CREATE TABLE SCHEDULE_MEMBERS(
	SCH_MEM_NO INT PRIMARY KEY AUTO_INCREMENT,
    USER_NO INT,
    SCHEDULE_NO INT
);
...
USER_NO INT, 
SUPPLY_NO INT, 
SUPPLY_COMPANY VARCHAR(50),
SUPPLY_NAME VARCHAR(100),
SUPPLY_QUANTITY INT,
RAW_INSPECTION_RESULT VARCHAR(20), CHECK(INSPECTION_RESULT IN ('합격', '불합격')),
INTERMEDIATE_INSPECTION_RESULT VARCHAR(20), CHECK(INSPECTION_RESULT IN ('합격', '불합격')),
PRODUCT_INSPECTION_RESULT VARCHAR(20), CHECK(INSPECTION_RESULT IN ('합격', '불합격')),
SHIPPING_DATE DATE,
